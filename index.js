...
// // Define your Azure Active Directory (AAD) tenant ID, client ID, and client secret
...
// // Initialize options with the credential
// const options = {
//   authProvider: {
//     getAccessToken: async () => {
//       // Get access token using the credential
...
// // Initialize the Microsoft Graph client with options
// const client = Client.init(options);

// async function getMessages() {
//   try {
//     // Retrieve messages with sender and subject information
...
//       console.log(`Sender: ${message.sender.emailAddress.name}, Subject: ${message.subject}`);
//     });
//   } catch (error) {
